...
namespace Trendlink.Infrastructure.Migrations
{
    ...
    [Migration("20240822131340_Added_UserId_FK")]
    partial class Added_UserId_FK
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trendlink.Domain.Users.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Trendlink.Domain.Users.UserToken", b =>
                {
                    b.HasOne("Trendlink.Domain.Users.User", "User")
                        .WithOne("Token")
                        .HasForeignKey("Trendlink.Domain.Users.UserToken", "UserId")
