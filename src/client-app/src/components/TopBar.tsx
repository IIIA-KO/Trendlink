            ...
            <div className="h-[300px] w-[120rem] flex flex-col gap-3">
                <div className="h-2/5 w-full flex flex-row mt-4">
                    <div className="h-full w-full flex items-center">
                        <img src={user?.profilePhotoUri || noProfile} alt="Profile avatar" className="sm:w-14 md:w-16 lg:w-20 xl:w-24 2xl:w-28 sm:h-14 md:h-16 lg:h-20 xl:h-24 2xl:h-28 sm:ml-6 md:ml-9 lg:ml-7 xl:ml-8 2xl:ml-10" />
                    </div>
                    <div
