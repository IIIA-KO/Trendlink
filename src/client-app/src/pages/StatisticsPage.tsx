              ...
              <div className="h-2/3 rounded-[15px] bg-background">
                ...
                <div className="w-[500px] h-[177px] left-[55px] top-[28px]">
                  <div className="w-[25px] h-[120px] left-[462px] top-[41px] absolute">
                    <div className="left-0 top-[105px] absolute text-[#3c3c3c] text-xs font-normal font-['Inter']">0%
                    </div>
                    <div className="left-0 top-[70px] absolute text-[#3c3c3c] text-xs font-normal font-['Inter']">20%
                    </div>
                    <div className="left-0 top-[35px] absolute text-[#3c3c3c] text-xs font-normal font-['Inter']">40%
                    </div>
                    <div className="left-0 top-0 absolute text-[#3c3c3c] text-xs font-normal font-['Inter']">60%</div>
                  </div>
                  <div
                      className="left-5 top-0 absolute text-[#3c3c3c] text-base font-bold font-['Inter'] uppercase">Вік
                  </div>
                  ...
                  <div
                      className="h-[15px] left-[19px] top-[162px] absolute justify-start items-start gap-[52px] inline-flex">
              ...
              <div className="h-2/3 rounded-[15px] mt-[10px] bg-background">
                <div className="w-96 h-60 relative">
                  ...
                  <div className="w-96 h-44 left-[15px] top-[33px] absolute">
                    <div
                        className="left-0 top-[1px] absolute text-[#3c3c3c] text-base font-bold font-['Inter'] uppercase">Топ
                      місцезнаходження
                    </div>
                    <div className="w-32 h-6 left-[371px] top-0 absolute">
                      ...
                      <div
                          className="h-5 left-[55px] top-[2px] absolute flex-col justify-start items-start gap-0.5 inline-flex">
                        <div className="text-[#3c3c3c] text-base font-normal font-['Inter']">Країни</div>
                      </div>
                    </div>
                    <div className="w-96 h-5 left-0 top-[50px] absolute">
                      <div className="left-0 top-0 absolute text-[#3c3c3c] text-sm font-normal font-['Inter']">Київ
                      </div>
                      <div
                          className="left-[442px] top-[2px] absolute text-[#3c3c3c] text-base font-normal font-['Inter']">60%
                      </div>
                    ...
                    <div className="w-96 h-5 left-0 top-[87px] absolute">
                      <div
                          className="left-0 top-[1px] absolute text-[#3c3c3c] text-sm font-normal font-['Inter']">Луцьк
                      </div>
                      <div
                          className="left-[442px] top-[2px] absolute text-[#3c3c3c] text-base font-normal font-['Inter']">30%
                      </div>
                      <div className="w-80 h-5 left-[72px] top-0 absolute bg-[#eaeaea]"/>
                    ...
                    <div className="w-96 h-5 left-0 top-[122px] absolute">
                      <div
                          className="left-0 top-[3px] absolute text-[#3c3c3c] text-sm font-normal font-['Inter']">Чернігів
                      </div>
                      <div className="w-80 h-5 left-[72px] top-0 absolute bg-[#eaeaea]"/>
                      <div
                          className="left-[442px] top-[2px] absolute text-[#3c3c3c] text-base font-normal font-['Inter']">20%
                      </div>
                      <div className="w-12 h-5 left-[72px] top-0 absolute bg-[#f3ae5f]"/>
                    </div>
                    <div className="w-96 h-5 left-0 top-[159px] absolute">
                      <div
                          className="left-0 top-[3px] absolute text-[#3c3c3c] text-sm font-normal font-['Inter']">Чернівці
                      </div>
                      <div className="w-80 h-5 left-[72px] top-0 absolute bg-[#eaeaea]"/>
                      <div
                          className="left-[442px] top-[2px] absolute text-[#3c3c3c] text-base font-normal font-['Inter']">25%
                      </div>
              ...
              <div className="items-center mt-20">
                <div className="w-52 h-72 flex-col justify-start items-start gap-10 inline-flex">
                  <div className="self-stretch h-10 flex-col justify-start items-start gap-1 flex">
                    ...
                    <div className="self-stretch text-[#3c3c3c] text-sm font-normal font-['Inter']">Середній коефіцієнт
                      залучення
                    </div>
                  </div>
                  <div className="self-stretch h-10 flex-col justify-start items-start gap-1 flex">
