        ...
        <div className="bg-background flex justify-start h-auto w-auto">
            ...
            <div className="w-5/6 h-auto">
                <div className="flex flex-col gap-2 border border-orange bg-custom-bg bg-cover bg-no-repeat rounded-[50px] h-auto w-auto min-h-screen min-w-screen sm:mr-24 md:mr-32 lg:mr-42 xl:mr-64 mt-10">
                    <TopBar />
                    <StatisticsBar />
                    <div className="h-1/4 w-full border-2 border-red-600 text-center text-black container">
                    ...
                    <div className="h-1/4 w-full flex flex-row xl:gap-20 2xl:gap-32  text-center text-black">
                        <div className="h-full relative w-3/5 mx-10 my-6">
                          <div className="h-2/3 rounded-[15px] bg-background border-2 border-emerald-700">
                          ...
                          <div className="h-2/3 rounded-[15px] mt-[10px] bg-background border-2 border-emerald-700">
                        ...
                        <div className="h-7/8 w-1/2 right-[60px] relative mx-10 my-6 rounded-[40px] bg-background border-2 border-emerald-700">
